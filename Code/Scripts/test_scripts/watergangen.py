...
def validate_network_topology(
    ...
    buffered_branches.geometry = buffered_branches.geometry.buffer(0.001, cap_style=2)
...
output_path = r"D:\Work\Project\HL-23006\GIS\Selectie_watergangen_21062023\sanitized.shp"
...
# branches_gdf = snap_nodes(branches_gdf, geometry_accuracy=geometry_accuracy)
# duikers_gdf = snap_nodes(duikers_gdf, geometry_accuracy=geometry_accuracy)
...
intersected_gdf = validate_network_topology(
    branches_sel_gdf, geometry_accuracy=geometry_accuracy
